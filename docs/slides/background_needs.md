...
> | # | 위치 | 정정 사유 |
> |---|---|---|
> | 1 | SLIDE 1 · 민감 정보 포함 시 | 확정 QA4는 *협상 상대*에게 후보안·선호가 노출되는 비율(≤20%)임. 원문은 위협 주체를 클라우드로 잡아 QA4와 어긋남 |
> | 2 | SLIDE 1 · 클라우드 처리 방식 | "최소 정보 교환" → QA4 표현인 "참여자 간 최소 정보 공개"로 일치 |
> | 3 | SLIDE 1 · 필수 요소 | IDS 삭제 — FR1~3·QA1~4·DP1·DP2 어디에도 Intent 감지가 없음 |
> | 4 | SLIDE 1 · 인용 박스 | IDS 삭제에 따라 "내 의도를 먼저 읽고" 구절 제거 |
> | 5 | SLIDE 2 · 온디바이스 LLM | IDS 삭제 |
> | 6 | SLIDE 2 · 소제목 | "기업·개인 모두 부재" ↔ 본문의 "기업 간 소수 선례 존재" 모순 해소 |
> | 7 | SLIDE 2 · Pactum 인용 | 저자·연도 표기와 arXiv 등록번호 불일치 — 확인 필요 주석 |
> | 8 | SLIDE 3 · 핵심 구성 | IDS 행·흐름 내 IDS 단계 삭제, 흐름을 확정 협상 절차로 교체 |
>
> 위 8건 외 문구·구성·인용은 원본 그대로 유지함.
